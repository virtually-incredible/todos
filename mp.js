//matrix module 1.5 from yyk@mail.ru
(function () {
  ...
  var get_md5, get_row_digest, vh_to_m, m_to_vh, csv_to_m, row_in_matrix, empty_matrix, add_car, v_tm, m_v,
    ...
    shuffle, summarize_column, concatenate_matrix, rotate_clockwise, get_columns;

  get_columns = function(m, idxs) {
    return m.map(function(r) {return idxs.map(function(idx) {return r[idx];});});
  };
